...
def online_lda(read_directory1, read_directory2, write_directory1, write_directory2, write_directory3):
    ...
    latent_topic_number = 10
    
    for i in range(212, 225):
        each_weibo_fenci = []
        all_weibo_word = []
...
if __name__ == '__main__':
    ...
    write_directory = root_directory + u'dataset2/LDA'
    ...
    write_directory1 = root_directory + u'dataset2/LDA/tf_corpus10'
    write_directory2 = root_directory + u'dataset2/LDA/doc_topic10'
    write_directory3 = root_directory + u'dataset2/LDA/topic_word10'
