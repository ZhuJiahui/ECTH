...
if __name__ == '__main__':
    ...
    read_directory = root_directory + u'dataset2/topic_model30'
    read_directory2 = root_directory + u'dataset2/text_model/select_words'
    write_directory = root_directory + u'dataset2/coherent_topic30'
    ...
    for i in range(212, 218):
        TW_vsm = np.loadtxt(read_directory + '/' + str(i + 1) + '/pw_z.k30')
        SPTW_vsm = sparse_DTvsm(TW_vsm, sp)
        
        DT_vsm = np.loadtxt(read_directory + '/' + str(i + 1) + '/pz_d.k30')
