...
def likelihood_join(Ta, Tb, dir_alpha, pai_gamma):
    ...
    pZm_Tm = pai_Tm * FDCM_T(T_vsm, dir_alpha) + (1 - pai_Tm) * Ta.gen_p * Tb.gen_p
...
def likelihood_absorb(Ta, Tb, dir_alpha, pai_gamma):
    ...
    pZm_Tm = pai_Tm * FDCM_T(T_vsm, dir_alpha) + (1 - pai_Tm) * Tb.gen_p * temp_product
...
def likelihood_collapse(Ta, Tb, dir_alpha, pai_gamma):
    ...
    pZm_Tm = pai_Tm * FDCM_T(T_vsm, dir_alpha) + (1 - pai_Tm) * temp_product
...
if __name__ == '__main__':
    ...
    read_directory = root_directory + u'dataset2/coherent_topic15/sparse_topic'
    read_directory2 = root_directory + u'dataset2/coherent_topic15/topic_pro'
    ...
    # 本片数据的主题比例
    proportion = []
    f1 = open(read_directory2 + '/' + str(213) + '.txt', 'rb')
    line = f1.readline()
    while line:
    ...
    TW_vsm = np.loadtxt(read_directory + '/' + str(213) + '.txt')
